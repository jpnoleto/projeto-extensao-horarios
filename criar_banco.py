...
if cursor.fetchone()['total'] == 0:
    ...
    if seed_default:
        cursor.execute("""
            ...
            VALUES (%s, %s, %s)
        """, ('Administrador', 'admin@escola.com', generate_password_hash('admin123')))
        print("\n[AVISO] Usuario administrador criado (somente para desenvolvimento):")
        print("  admin@escola.com / admin123")
        print("  TROQUE A SENHA antes de usar em qualquer ambiente real.\n")
    else:
        print("\n[INFO] Nenhum usuario criado.")
        print("  Para popular o admin default em DEV: DB_SEED_DEFAULT_USERS=true python criar_banco.py")
        print("  Ou crie o administrador via INSERT manual:")
        print("    INSERT INTO usuario (nome, email, senha_hash)")
        print("    VALUES ('Seu Nome', 'voce@dominio.com', '<hash gerado>');")
